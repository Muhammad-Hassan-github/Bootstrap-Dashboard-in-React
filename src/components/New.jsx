        ...
        <aside class="side-nav" id="show-side-navigation1">
          ...
          <ul class="categories">
            ...
            <li>
              ...
              <a href="#">
                {" "}
                Messages <span class="num dang">56</span>
              </a>
            </li>
            <li>
              ...
              <a href="#">
                {" "}
                Settings <span class="num prim">6</span>
              </a>
              <ul class="side-nav-dropdown">
                <li>
                  <a href="#">Lorem ipsum</a>
            ...
            <li>
              ...
              <a href="#">
                {" "}
                About UI &amp; UX <span class="num succ">43</span>
              </a>
            </li>
            <li>
                ...
                <ul class="nav navbar-nav">
                  <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                      <li>
                        <a href="#">
                          <i class="fa fa-user-o fw"></i> My account
                        </a>
                      </li>
                      <li>
                        <a href="#">
                          <i class="fa fa-envelope-o fw"></i> My inbox
                        </a>
                      </li>
                      <li>
                        <a href="#">
                          <i class="fa fa-question-circle-o fw"></i> Help
                        </a>
                      </li>
